...
if __name__ == '__main__':
    storage = Storage()
    storage.add(Printer.create(4, vendor="HP", model="M254dw"))
    storage.add(Scanner.create(3, vendor="Canon", model="LiDE 400"))
    storage.add(Scanner.create(2, vendor="Mustek", model="H410W"))
    storage.add(Xerox.create(6, vendor="HP Deskjet ", model="5820"))
    print(storage)
