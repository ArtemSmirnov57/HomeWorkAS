...
police_car = PoliceCar("Полицейский авто", "белый с черным", 75)
police_car.go()
...
work_car = WorkCar("Грузовой авто", "синий", 40)
work_car.go()
work_car.turn(1)
...
sport_car = SportCar("Спортивный авто", "черный", 140)
sport_car.go()
sport_car.turn(0)
...
town_car = TownCar("Городской автомобиль", "Зеленый", 60)
town_car.go()
town_car.turn(0)
town_car.turn(0)
